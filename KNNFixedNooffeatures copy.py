...
# Load dataset
df = pd.read_csv("C:/Users/User/Downloads/orange_dataset.csv")  # Use full path if running locally
...
x_labels = [f"Index {i}" for i in top_indices]  # fixed: using DataFrame index
